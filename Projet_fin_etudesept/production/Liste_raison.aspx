<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_raison.aspx.vb" Inherits="production_Liste_raison" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des raisons</li>
</ol>
				</div> 
              <div class="page-title">
              <div class="title_left">
                 <div class="col-md-12" style="font-size: 20px;">
        Liste  des secteurs raisons d'arbattage
			      </div>
              </div>
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouvelle raison</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("Id_raison")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("raison")%>'></asp:TextBox></td>
                                          <%--   <td><asp:TextBox ID="tb_update_code_piege" CssClass="form-control" runat="server" Text='<%# Bind("Tarif")%>'></asp:TextBox></td>--%>
                                            
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("Id_raison")%>'></asp:TextBox>
                                             <td>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter raison d'arbattage</h4>
                        </div>
                        <div class="modal-body">
                        <div class="form-group">
                            
              <label for="recipient-name" class="form-control-label">Raison </label>
