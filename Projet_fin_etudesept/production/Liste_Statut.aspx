<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_Statut.aspx.vb" Inherits="production_Liste_Statut" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des statuts</li>
</ol>
				</div> 
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouveau statut</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Statut")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("Statut")%>'></asp:TextBox></td>
                                          
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("ID_Statut")%>'></asp:TextBox>
                                             <td>
              ...
              <label for="recipient-name" class="form-control-label">Statut </label>
             <asp:TextBox runat="server" id="txt_statut" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez le secteur" required="required" type="text"></asp:TextBox>
