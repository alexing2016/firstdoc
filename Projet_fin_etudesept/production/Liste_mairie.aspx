<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_mairie.aspx.vb" Inherits="production_Liste_mairie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des secteurs</li>
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouvelle mairie</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("Id_mairie")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("nom_mairie")%>'></asp:TextBox></td>
                                             
                                            
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("Id_mairie")%>'></asp:TextBox>
                                             <td>
             ...
             <asp:TextBox runat="server" id="txt_fonction" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez la mairie" required="required" type="text"></asp:TextBox>
