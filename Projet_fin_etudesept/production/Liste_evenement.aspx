<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_evenement.aspx.vb" Inherits="production_Liste_evenement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des secteurs</li>
    ...
    <div id="contenu">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouveau monument</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("Id_monument")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("nom_monument")%>'></asp:TextBox></td>
                                             ...
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("Id_monument")%>'></asp:TextBox>
                                             <td>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter monument historique</h4>
                        </div>
                        <div class="modal-body">
                        <div class="form-group">
                            
              <label for="recipient-name" class="form-control-label">Monument </label>
             <asp:TextBox runat="server" id="txt_fonction" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez le monument" required="required" type="text"></asp:TextBox>
          
                              </div>
                          <div class="form-group">
     <label for="recipient-name" class="form-control-label">Mairie</label>
             <asp:dropdownlist runat="server" ID="rcmb_mairie" class="form-control col-md-7 col-xs-12"></asp:dropdownlist>
</div>
