<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_demande_en_cours.aspx.vb" Inherits="production_Liste_demande_en_cours" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste  des abattages en attente</li>
</ol>
				</div> 
              <div class="page-title">
              <div class="title_left">
                 <div class="col-md-12" style="font-size: 20px;">
      Liste  des abattages autorisés
			      </div>
              </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                          ...
                          <td><%#Eval("Tarif")%></td>      
                           <td><a href="../production/formulaire_demande.aspx?ID=<%#Eval("ID_secteur")%>"><i class="fa fa-search"></i></a></td>  
