<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_patente_en_attente.aspx.vb" Inherits="production_Liste_patente_en_attente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des patentes en attente</li>
</ol>
				</div> 
              <div class="page-title">
              <div class="title_left">
                 <div class="col-md-12" style="font-size: 20px;">
        Liste  des patentes en attente
			      </div>
              </div>
            ...
            <ItemTemplate>
                 <tr>
                     ...
                     <td><%#Eval("Nom_forme")%></td> 
                      ...
                      <td><%#Eval("Montant")%></td>  
                      <td class= "btn btn-info btn-xs"><%#Eval("Statut")%></td>  
