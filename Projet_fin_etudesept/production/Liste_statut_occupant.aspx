<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Liste_statut_occupant.aspx.vb" Inherits="production_Liste_statut_occupant" %>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter statut</h4>
                        </div>
                        <div class="modal-body">
                        <div class="form-group">
                            
              <label for="recipient-name" class="form-control-label">Statut</label>
             <asp:TextBox runat="server" id="txt_statut" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez le statut" required="required" type="text"></asp:TextBox>
