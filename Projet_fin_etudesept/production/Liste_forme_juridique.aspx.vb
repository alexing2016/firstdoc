...
Partial Class production_Liste_forme_juridique
    ...
    Private Sub Load_forme()

        Try
            Using entities As New SGCT_dbEntities
                Dim fonctions = From func In entities.Tbl_forme_juridique
                            Select func
    ...
    Protected Sub RadBtn_Save_Click(sender As Object, e As EventArgs) Handles RadBtn_Save.Click
        Using entities As New SGCT_dbEntities
            ...
            Dim secteur As New Tbl_forme_juridique
            secteur.Nom_forme = txt_fonction.Text
            '  secteur.descriptition = txt_montant.Text

            secteur.DateCreated = DateTime.Now
            entities.Tbl_forme_juridique.Add(secteur)
    ...
    Protected Sub lv_all_pieges_ItemCanceling(sender As Object, e As ListViewDeleteEventArgs) Handles rlv_part.ItemDeleting
        ...
        Dim fonction As Tbl_forme_juridique = entities.Tbl_forme_juridique.Find(id)

        Dim confirmValue As String = Request.Form("confirm_value")
        If confirmValue = "Yes" Then

            entities.Tbl_forme_juridique.Remove(fonction)
    ...
    Protected Sub rlv_part_ItemUpdating(sender As Object, e As ListViewUpdateEventArgs) Handles rlv_part.ItemUpdating
        ...
        Dim piege As Tbl_forme_juridique = entities.Tbl_forme_juridique.Find(id)
        Try
            piege.Nom_forme = CType(dataItem.FindControl("tb_update_lon_piege"), TextBox).Text
